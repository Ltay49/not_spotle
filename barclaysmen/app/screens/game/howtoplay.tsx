...
export default function HowToPlay({ setHowToPlay }: HowToPlayProps) {
   ...
   <Text style={styles.buttonText1}>THE AIM</Text>
                    ...
                    <View style={styles.row}>
                        <Image style={styles.footballTeams} source={Football} />
                    ...
                    <TouchableOpacity style={styles.buttonGp} onPress={handleSubmitGp}>
                        <Text style={styles.buttonGpText}>How to play...Game Play Here</Text>
                        <Icon name="arrow-right" size={18} color='#0063A1' />
                    </TouchableOpacity>
                </ScrollView>
            </View>
        </Animated.View>
